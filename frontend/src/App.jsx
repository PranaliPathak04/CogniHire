...
async function generatePDF(result, fileName, userEmail) {
  if (!window.jspdf) {
...
.job-modal-body::-webkit-scrollbar-thumb { background: var(--accent); border-radius: 10px; }
.job-modal-body::-webkit-scrollbar-thumb:hover { background: var(--accent); }
`;
